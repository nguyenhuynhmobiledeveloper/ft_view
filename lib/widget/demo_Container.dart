      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            // Nếu không Container con sẽ phát triển to ra bằng Container cha

            Container(
              width: 200.0,
              height: 200.0,
              color: Colors.orange,
              alignment: Alignment.topLeft, // Chỉ định vị trí mà widget con sẽ nằm trong
              child: Container(
                width: 50.0,
                height: 50.0,
                color: Colors.blue,
            ...
            Container(
              ...
              padding:const EdgeInsets.symmetric(
                  vertical: 30,
                  horizontal: 80), // Padding là phần ruột cách viền các khoảng cách
...
Bạn có thể tạo mới Aligment với giá trị x, y mong muốn hoặc sử dụng các hằng số có sẵn.
      ...
      child: Container(
        ...
        alignment: Alignment(-1, -1),  // dọc -1 ở trên , ngang -1 ở bên trái 
      )
