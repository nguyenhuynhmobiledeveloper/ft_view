...
class _DemoScaffoldState extends State<DemoScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    //Scaffold là full đầy đủ giao diện 1 màn hình :
    // appbar, body , bottomNavigationBar, floatingActionButon , floatingActionButtonLocation "Vị trí của floattingActionButton"
    return DefaultTabController(
      ...
      child: (Scaffold(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  ListTile(
                    leading: Icon(Icons.add_card),
                    title: Text('Demo SingleChildScrollView'),
                    onTap: () {
                      Navigator.pushNamed(context,
                          "/SingleChildScrollView"); // Chuyển sang màn hình Demo SingleChildScrollView
                    },
                  ),
                  ListTile()
                ],
          ...
          // BottomAppBar : Phần thanh điều hướng BottomAppBar : thường dùng để đặt các nút điều hướng ở dưới màn hình
          ...
          //     .centerFloat // Ở giữa phía trên BottomBarApp
          // floatingActionButtonLocation: FloatingActionButtonLocation
          //     .centerTop // Ở giữa trên - dưới AppBar

          // Ở giữa nằm đè phía trên BottomBarApp - thường dùng khi BottomBarApp có notch để bo tròn né FloatingActionButton
